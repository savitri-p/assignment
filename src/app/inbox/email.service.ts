...
export class EmailsService {
  ...
  },
  {
    ...
    "body": "Here are this week's five links that are worth your time: 1. Learn Back End Development in Node.js. This free JavaScript course will teach you the fundamentals (3 hour watch): <a href='https://www.freecodecamp.org/news/getting-started-with-node-js/' target='_blank'>https://www.freecodecamp.org/news/getting-started-with-node-js/</a> 2. How to...",
